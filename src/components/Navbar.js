        ...
        <div className='bg-[#1F1616] w-[221px] h-screen'>
            ...
            <div className='ml-14 mt-8'>
                ...
                <div className={`ml-6 ${navbarOpen ? "flex flex-col" : "hidden"}`}>
                    <a href='#' className='text-white font-semibold text-sm cu hover:opacity-80'>HyperVisor</a>
                    <a href='#' className='text-white font-semibold text-sm my-3 hover:opacity-80'>OpenStack</a>
                    <a href='#' className='text-white font-semibold text-sm hover:opacity-80'>VMware</a>
                </div>
